...
function textConstructor() {
    ...
    newTable.appendChild(newHeadline);
    headline.appendChild(newTable);
...
function startFrameTwo(){
    ...
    // newTable.classList.add("table");
    // var newHeadline = document.createElement("div");
    // var textSizeHex = styleArray[1].split("|");
    // newHeadline.style.fontSize = textSizeHex[0] + "px";
    // newHeadline.style.color = textSizeHex[1];
    // newHeadline.style.lineHeight = (parseInt(textSizeHex[0]) + 5) + "px";
    // newHeadline.className = "headlines transitionOne";
    // newHeadline.id = "F2_headline";
    // var headlineParts = headlineArray[1].split("|");
    // for(var j = 0; j < headlineParts.length; j++){
    //     var inlineHead = document.createElement("span");
    //     inlineHead.classList.add("hide");
    //     inlineHead.classList.add("transitionOne");
...
function startFrameThree(){
    ...
    // var newHeadline = document.createElement("div");
    // var textSizeHex = styleArray[2].split("|");
    // newHeadline.style.fontSize = textSizeHex[0] + "px";
    // newHeadline.style.color = textSizeHex[1];
    // newHeadline.style.lineHeight = (parseInt(textSizeHex[0]) + 5) + "px";
    // newHeadline.className = "transitionOne";
    // newHeadline.id = "F3_headline";
    // var headlineParts = headlineArray[2].split("|");
    // for(var j = 0; j < headlineParts.length; j++){
    //     var inlineHead = document.createElement("span");
    //     inlineHead.classList.add("hide");
    //     inlineHead.classList.add("transitionOne");
    ...
    Adjust_Brushwing.style.transform = "translate(171px, -58px)";
    setTimeout(function(){
        cta.style.opacity = "1";
    }, ctaTime);
    setTimeout(function(){
        bird_cover.style.transform = "translateY(-32px)";
    }, 3000)
